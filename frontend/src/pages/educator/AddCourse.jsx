      ...
      <form onSubmit={handleSubmit} action="#">
        ...
        <div className='flex items-center justify-between flex-wrap'>
          <div className='flex flex-col gap-1'>
            ...
            className='outline-none md:py-2.5 py-2 w-28 px-3 rounded border border-gray-500' required /><input type="text" />
          </div>
        ...
        <div>
                ...
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex)=>(
                    <div key={lectureIndex} className='flex items-center justify-between mb-2'>
                      <span>{lectureIndex +1} {lecture.lectureTitle} - {lecture.lectureDuration} mins <a href={lecture.lectureUrl} target='_blank' className='text-blue-600'>-Link</a> - {lecture.isPreviewFree ? 'Free Preview' : 'Paid'}</span>
          ...
          <div onClick={()=> handleChapter('add')} className='flex justify-center items-center bg-blue-100 p-2 rounded-lg cursor-pointer mt-2'>+Add Chapter</div>

          {showPopUp && (
            <div className='flex inset-0 justify-center items-center bg-gray-800 bg-opacity-50 absolute'>
              <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                <h2 className='text-lg font-semibold mb-4'>Add lecture</h2>
                 ...
                 <button onClick={addLectures} type='button' className='w-full bg-blue-400 text-white px-4 py-2 rounded'>Add</button>
