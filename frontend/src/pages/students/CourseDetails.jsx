...
const CourseDetails = () => {
  ...
  const {currency, allCourses , calculateRating, calculateChapterTime, calculateCourseTime, calculateNoOfLectures} = useContext(AppContext)
  ...
  return courseData ? (
    <>
    <div className='flex md:flex-row flex-col-reverse gap-10 items-start relative justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
